...
var DetallePacienteEdit = React.createClass({
  ...
  show: function(nombre_original,paciente,detalle) {
    //aqui limpiar componente
    var pacienteDto = this.state.pacienteDto;
    pacienteDto.paci_direccion=detalle.pac_direccion;
    pacienteDto.paci_telefono=detalle.pac_celular;
    pacienteDto.paci_correo=detalle.pac_correo;
    pacienteDto.paci_ocupacion=detalle.pac_ocupac;
    pacienteDto.paci_tipo=detalle.pac_tipo;
    pacienteDto.paci_foto=detalle.pac_foto;
    pacienteDto.paci_estado=detalle.pac_estado;
    console.log('here detalle paciente');
...
module.exports = DetallePacienteEdit;
